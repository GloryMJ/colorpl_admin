...
import { Table, TableBody, TableCell, TableHead, TableRow, Box, Button, TextField, FormControl, InputLabel, Select, MenuItem, Pagination, Snackbar, Alert, Typography, Chip, Modal, Checkbox, Paper } from '@mui/material';
import api from '../api';
  ...
  const loadActivityData = useCallback(async () => {
    ...
    try {
      ...
      const transformedData = response.data.map(review => ({
        ...review,
        is_spoiler: Boolean(review.is_spoiler)  // 스포일러 여부 변환
      }));
