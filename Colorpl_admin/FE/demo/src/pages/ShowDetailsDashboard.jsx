...
const ShowDetailsDashboard = () => {
  ...
  const handleRowClick = (show_detail_id) => {
    navigate(`/showdetails/${show_detail_id}`);
  };
          ...
          <Table>
            ...
            <TableBody>
              {showDetails.map((show) => (
                <TableRow key={show.show_detail_id} hover onClick={() => handleRowClick(show.show_detail_id)}>
