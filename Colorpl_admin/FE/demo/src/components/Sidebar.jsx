...
import { People as PeopleIcon, Comment as CommentIcon, Movie as MovieIcon, Dashboard as DashboardIcon, Assignment as AssignmentIcon, Store as StoreIcon, TheaterComedy as TheaterComedyIcon, ManageAccounts as ManageAccountsIcon, ShoppingCart as ShoppingCartIcon, Report as ReportIcon } from '@mui/icons-material'; // ReportIcon 추가
    ...
    <Box sx={{ display: 'flex', height: '100%' }}>
      ...
      >
        <List>
          ...
          {user?.role === 1 && (  // role이 1인 경우에만 신고 내역 항목을 표시
            <ListItem
              button
              component={Link}
              to="/reports"
