...
import ShowingDetailPage from './pages/ShowingDetailPage';
import api from './api';
      ...
      <Router>
        ...
        >
          <Routes>
            ...
            <Route path="/showdetails/:show_detail_id" element={<PrivateRoute><ShowingDetailPage user={user} /></PrivateRoute>} />
            {user && user.role === 1 && (
