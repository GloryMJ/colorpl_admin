from sqlalchemy import Column, String, Integer, BigInteger, Enum, DateTime, ForeignKey, Float, Boolean, Text, func, TypeDecorator
from sqlalchemy.orm import relationship, Session
from sqlalchemy.types import Boolean as SQLA_Boolean
...
class Review(Base, BaseEntity):
    ...
    is_spoiler = Column(Integer)  # BIT(1)을 처리할 수 있도록 BitBoolean을 사용
