...
from database import Base as Base1 , engine as engine1
from auth.database import Base as Base2 , engine as engine2
...
from auth.logging import router as router_logging
from auth.report import router as router_report
...
app.include_router(router_logging, prefix='/auth', tags=["log"])
app.include_router(router_report, prefix='/auth', tags=["reports"])
app.include_router(router_register, prefix='/vm', tags=["register"])
